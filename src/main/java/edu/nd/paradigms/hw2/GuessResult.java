...
public class GuessResult {
    ...
    /**
     * This function ensures that the guess and answer is valid at object construction time.
     * Hint to students: You should *not* use or modify this function in your own code!
     * @param guess - The player's guessed answer
